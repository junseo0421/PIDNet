...
class FullModel(nn.Module):
  ...
  def __init__(self, model, sem_loss, bd_loss, is_teacher=False):
  ...
  def forward(self, inputs, labels, bd_gt, *args, **kwargs):
    ...
    outputs, features = self.model(inputs, *args, **kwargs)
